...
async def recut_clip(req: RecutRequest):
    ...
    try:
        ...
        default_hook_style = _coerce_caption_style(
            position="top",
            font_size=37,
        ...
        hook_style = _coerce_caption_style(
            position="top",
            font_size=(req.viral_hook_font_size if req.viral_hook_font_size is not None else default_hook_style.get("font_size")),
            font_family=(req.viral_hook_font_family if req.viral_hook_font_family else default_hook_style.get("font_family")),
            font_color=(req.viral_hook_font_color if req.viral_hook_font_color else default_hook_style.get("font_color")),
            stroke_color=(req.viral_hook_stroke_color if req.viral_hook_stroke_color else default_hook_style.get("stroke_color")),
            stroke_width=(req.viral_hook_stroke_width if req.viral_hook_stroke_width is not None else default_hook_style.get("stroke_width")),
            bold=(req.viral_hook_bold if req.viral_hook_bold is not None else default_hook_style.get("bold")),
            box_color=(req.viral_hook_box_color if req.viral_hook_box_color else default_hook_style.get("box_color")),
            box_opacity=(req.viral_hook_box_opacity if req.viral_hook_box_opacity is not None else default_hook_style.get("box_opacity")),
            karaoke_mode=False,
            subtitle_animation="none",
            speaker_color_mode=False,
            speaker_color_palette=None,
